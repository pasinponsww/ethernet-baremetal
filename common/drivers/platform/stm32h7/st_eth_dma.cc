...
// using StEthDma_Desc = StEthDma<TxRingSize, RxRingSize>

// StEthDma_Desc::StEthDma(StEthDmaSettings<TxRingSize, RxRingSize> config) : params(config)
// {}

// bool StEthDma_Desc::init()
// {
//     bool result{true};
...
//     // ETH_DMACRCR - Channel Receive Control Register (buffer size must be multiple of 4)
//     SetReg(&(params.base_addr->DMACRCR),
//         static_cast<uint32_t>(params.rx_buff_size),
