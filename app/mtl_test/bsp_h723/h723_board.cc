...
// The MTL sits below the MAC in the same ETH peripheral, so it needs the
// MAC brought up (clocks + MACCR) to have anything meaningful to test.
...
StEthMtl mtl{mtl_params};

// The one and only board instance
Board<StEthMac, StEthMtl, StGpio, StRcc, StSysclk, StUsart> board{
    mac, mtl, tx, rx, rcc, clock, usart,
};
...
template <>
Board<StmH7::StEthMac, StmH7::StEthMtl, StmH7::StGpio, StmH7::StRcc,
      StmH7::StSysclk, StmH7::StUsart>&
get_board<StmH7::StEthMac, StmH7::StEthMtl, StmH7::StGpio, StmH7::StRcc,
          StmH7::StSysclk, StmH7::StUsart>()
{
    return StmH7::board;
}
...
HwBoard& get_hw()
{
    return get_board<StmH7::StEthMac, StmH7::StEthMtl, StmH7::StGpio,
